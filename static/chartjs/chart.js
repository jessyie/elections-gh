...
//     }).addTo(map);
    ...
    function createValidVotesGeoJSON(parliament10) {
        return L.geoJSON(parliament10, {
            onEachFeature: function(feature, layer) {
            if (feature.properties) {
                var tooltipContent = "Region: " + feature.properties['region'] + "<br>" + "Winner: " + feature.properties['Winner'] + " " + feature.properties['Winner_Percentage'] + "%" + "<br>" + "Second place: " + feature.properties['Second_Highest_Value_Name'] + " " + feature.properties['Second_Highest_Percentage'] + "%";
...
// }).addTo(map);
    ...
    function createValidVotes_ConstGeoJSON(parliamentConst16CONST2) {
        return L.geoJSON(parliamentConst16CONST2, {
            onEachFeature: function(feature, layer) {
            if (feature.properties) {
                var tooltipContent = "Constituency: " + feature.properties['Constituen'] + "<br>" + "Constituency Code: " + feature.properties['ConstCode'] + "<br>" + "Winner: " + feature.properties['Winner'] + " " + feature.properties['Winner_Percentage'] + "%" + "<br>" + "Second place: " + feature.properties['Second_Highest_Value_Name'] + " " + feature.properties['Second_Highest_Percentage'] + "%";
                 // Dynamically add previous years' winner data
                for (var key in feature.properties) {
                    // Look for all keys that start with "Winner_" to get past election winners
                    if (key.startsWith("Winner_")) {
...
// }).addTo(map)
    ...
    var overlayMaps = {
        ...
        'Parliament 10 constituencies' : parliamentConst_16CONST2_10,
        'Presidential 10 constituencies' : presidentialConst_16CONST2_10,
        'Parliament 16 constituencies' : parliamentConst_16CONST2,
        'Presidential 16 constituencies' : presidentialConst_16CONST2,
    ...
    var overlayMaps2 = {
        ...
        'Flash Incident Constinuencies' : flashCONST2NEW,
...
// }
    ...
    overlayMaps['Parliament 16 constituencies'].clearLayers();
    ...
    overlayMaps['Parliament 16 constituencies'] = parliamentConst_16;


    overlayMaps['Parliament 10 constituencies'].clearLayers();
    ...
    overlayMaps['Parliament 10 constituencies'] = parliamentConst_16_10;

    overlayMaps['Presidential 16 constituencies'].clearLayers();
    ...
    overlayMaps['Presidential 16 constituencies'] = presidentialConst_16;


    overlayMaps['Presidential 10 constituencies'].clearLayers();
    ...
    overlayMaps['Presidential 10 constituencies'] = presidentialConst_16_10;
    ...
    overlayMaps2['Flash Incident Constinuencies'].clearLayers();
    ...
    overlayMaps2['Flash Incident Constinuencies'] = flashCONST2;
    ...
    map.removeLayer(overlayMaps['Parliament 10 constituencies']);

    map.removeLayer(overlayMaps['Presidential 10 constituencies']);
    ...
    map2.removeLayer(overlayMaps2['Flash Incident Constinuencies']);
  ...
  .then(data => {
    ...
    if (year === "2004" || year === "2008" || year === "2009" || year === "2012" || year === "2016") {
      ...
      bindClickToDynamicLayers(presidentialConst_16_REG2, 'map');  
        ...
        presidentialConst_16_REG = jsoncreateValidVotes_ConstGeoJSON(merged2_GHMap2Const).addTo(map);
        bindClickToDynamicLayers(presidentialConst_16_REG, 'map');
    }
 ...
 // Function to update marker size based on zoom level
    ...
    function updateLayerVisibility(region, year) {
        ...
        if (mapZoom >= 6) {
            ...
            map.addLayer(overlayMaps['Presidential 10 constituencies']);
            regionsData.eachLayer(function(layer) {
                layer.setStyle({
                // Set your highlighting style here
                    fillOpacity: 0
        ...
        if (mapZoom >= 6) {
            map.addLayer(polling_stationData);
            map.addLayer(overlayMaps['Presidential 16 constituencies']);
            regionsData.eachLayer(function(layer) {
                layer.setStyle({
                // Set your highlighting style here
                    fillOpacity: 0
